...
const geocode = (address, callback) => {
    ...
    const url = 'https://api.mapbox.com/geocoding/v5/mapbox.places/' + encodeURIComponent(address) + '.json?access_token=pk.eyJ1IjoidmFsaWVuMSIsImEiOiJja3F6dGxvZDIwdjNxMnZvN3RlNzczYnJnIn0.iEIkID2TBih0qHc37zhZ7w'
